      ...
      <div class="row">
          ...
          <div class="form_contaier">
            <form method="post" name="contactanos" id="contactanos" onsubmit="event.preventDefault(); sendData_contactanos();">
              <div class="form-group">
                ...
                <input type="text" required name="nombres" class="form-control" id="exampleInputName1">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="action" value="contactanos">
        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <p>
 Organiza y accede fácilmente a la información de tus pacientes con nuestro sistema de almacenamiento seguro y eficiente.
            </p>
          </div>
        </div>
      </div>
  ...
  function sendData_contactanos(){
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        if (info.noticia_email == 'envio_exitoso') {
          $('.notificacion_contactanos').html('<div class="alert alert-success" role="alert">Mensaje Enviado Correctamente!</div>');

        }
        if (info.noticia == 'error') {
          $('.notificacion_contactanos').html('<div class="alert alert-danger" role="alert">Error en el servidor!</div>');
