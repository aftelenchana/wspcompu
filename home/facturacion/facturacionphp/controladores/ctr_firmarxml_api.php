<?php
set_time_limit(300);
require_once './ctr_funciones_api.php';
require_once '../lib/nusoap.php';
//require_once 'ruth_esmeralda_sanchez_herrera.p12';
//if (isset($_POST['submit'])) {
class autorizar {
	public function autorizar_xml($secuencial,$id_usuario_logeado,$contenido_colateral_rt) {
		include "../../../../coneccion.php";
			include "ctr_pdf_new_api.php";
    	 $iduser= $id_usuario_logeado;
			 $codigo_factura_SC= $secuencial;
		...
		if (openssl_pkcs12_read($almacen_cert, $info_cert, $clave)) {
			...
			////codigo para pruebas
	    //$func = new fac_ele();
 			//$crecion = crecion($clave_acc_guardar,$codigo_factura_SC,$id_usuario_logeado);
      //$func->correos($clave_acc_guardar,$codigo_factura_SC,$numDocModificado,$id_usuario_logeado);
    //  $func->compr_final($clave_acc_guardar,$codigo_factura_SC,$numDocModificado,$id_usuario_logeado);
