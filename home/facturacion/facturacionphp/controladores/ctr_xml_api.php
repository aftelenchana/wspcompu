...
class xml{
	public function xmlFactura($secuencial,$id_usuario_logeado,$contenido_colateral_rt){
	...
	$xml_tsi = $xml->createElement('totalSinImpuestos',$compra_total_dt-$descuento_general);
	...
	$a = 1;
			while ($resultados = mysqli_fetch_array($query_resultados)) {
					...
					$xml_cop[$a] = $xml->createElement('codigoPrincipal',$resultados['codigo_secundario']);
