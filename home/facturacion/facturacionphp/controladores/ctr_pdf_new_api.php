...
use Dompdf\Options;
 ...
 function crecion($clave_acc_guardar,$codigo_factura_SC,$id_usuario_logeado){
	 ...
	 $codigo_factura = $codigo_factura_SC;
	  ...
	  $html=file_get_contents("$url2/home/pdf/factura.php?id=$iduser&clave_acc_guardar=$clave_acc_guardar&codigo_factura=$codigo_factura");
