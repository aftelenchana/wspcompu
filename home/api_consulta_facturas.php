...
<html lang="es">
    ...
    <head>
        <title>Apí Consulta de Facturas Realizadas</title>
        <meta charset="utf-8" />
                                          ...
                                          <div class="card">
                                              ...
                                              <?php
                                               ...
                                               <div class="contenedor_parrafos_principales">
                                                 <p>Hola <?php echo $nombres ?> nos encanta saber que eres parte de nuestra Familia de Desarrollo y para esto te presentamos la api de Consulta de  Facturas  de <a target="_blank" href="https://guibis.com">guibis.com</a>,
                                               ...
                                               <div class="card">
                                                   ...
                                                   <div class="card-block">
                                                       <p>Te presento la URL a la cual te debes de conectar mediante metodo   <strong> GET .</p>
                                                       <h6 class="m-t-20 f-w-600">Usage:</h6>
                                                       <pre>
                                                   <code class="language-markup">
                                                       <?php echo $url2 ?>/dev/facturas?user=279</strong>
                                                   </code>
                                               </pre>
                                                   </div>
                                               </div>
