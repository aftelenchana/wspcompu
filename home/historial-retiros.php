                                            ...
                                            <div class="">
                                              <table>
                                                <tr class="titu_table">
                                                  ...
                                                  <?php
                                                  $id_user           =  $_SESSION['id'];
                                                  $query_lista = mysqli_query($conection,"SELECT * FROM retiros_leben1804843900
                                                              WHERE id_usuario = $iduser    ORDER BY fecha DESC ");
                                                        while ($data_lista=mysqli_fetch_array($query_lista)) {

                                                   ?>
                                                   <tr>
                                                     <td data-titulo="Monto"><?php echo round($data_lista['cantidad'],2)?></td>
                                                     ...
                                                     <td data-titulo="Acciones">
                                                       <a href="detalles-retiros.php?movimiento_retiro=<?php echo $data_lista['id'] ?>">Detalles</a>
                                                       <a href="#">Reportar</a>
                                                     </td>
                                                   </tr>
                                                 <?php
