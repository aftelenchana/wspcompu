...
var btnDictado = document.getElementById('btn_clientesdictado_clientes');
...
if (typeof reconocimientoVoz !== 'undefined') {
    reconocimientoVoz.onresult = function(event) {
        ...
        document.getElementById('actividad_economica').value = resultado;
    };
}
...
function guardarDatosAutomaticamente() {
  const formulario = document.getElementById('add_cliente');
