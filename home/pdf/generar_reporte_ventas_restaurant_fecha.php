...
$nombre_empresa          = $result['nombre_empresa'];
 ...
 $protocol = empty($_SERVER['HTTPS']) ? 'http://' : 'https://'; $domain = $_SERVER['HTTP_HOST']; $url = $protocol . $domain;
  ...
  $html=file_get_contents_curl("$url/home/pdf/ganancias_fecha_restaurante.php?iduser=$iduser&fecha1=$fecha1&fecha2=$fecha2");
...
$pdf->stream('Ganancias_('.$fecha1.'-'.$fecha2.')-'.$nombre_salida.'.pdf');
