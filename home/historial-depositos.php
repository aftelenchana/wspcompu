...
<html lang="es">
    ...
    <head>
        <title>Historial Dépositos</title>
                                ...
                                <div class="col">
                                    <div class="text-center mb-3">
                                        <a href="/home/active-token">
                                            <img src="https://guibis.com/home/img/qr_bancario/<?php echo $qr_bancario ?>" alt="QR Bancario" class="img-fluid" >
                                        </a>
                                    </div>
                                    <div class="card">
                                        <div class="card-body">
                                          ...
                                          <div class="histial_bancario_general" style="padding: 15px;">
                                            <div class="">
                                              <table>
                                                ...
                                                <?php
                                                $query_lista = mysqli_query($conection,"SELECT * FROM saldo_leben_1804843900
                                                            WHERE id_usuario = $iduser    ORDER BY fecha_deposito DESC ");
                                                      while ($data_lista=mysqli_fetch_array($query_lista)) {

                                                 ?>
                                                                 <tr>
                                                         <td data-titulo="Cantidad">$<?php echo round($data_lista['cantidad'],2)?></td>
                                                         <td data-titulo="Metodo"><?php echo ($data_lista['tipo_banco'])?></td>
                                                         <td data-titulo="Metodo"><?php echo ($data_lista['metodo'])?></td>
                                                         <td data-titulo="Fecha"><?php echo ($data_lista['fecha_deposito'])?></td>
                                                         <td data-titulo="Estado"><?php echo $data_lista['estado'];  ?></td>
                                                         <td data-titulo="Enlaces">
                                                           <a href="detalles-deposito.php?movimiento_deposito=<?php echo $data_lista['id'] ?>">Detalles</a>
                                                           <a href="#">Reportar</a>
