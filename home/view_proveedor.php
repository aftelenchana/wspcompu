                                                  ...
                                                  <div class="dt-responsive table-responsive">
                                                      <table id="tabla_productos" class="table table-striped table-bordered nowrap">
                                                          ...
                                                          <tbody>
                                                            ...
                                                            $query_lista = mysqli_query($conection,"SELECT * FROM proveedor where estatus = 1 and iduser=$iduser   ");
                                                            $result_lista= mysqli_num_rows($query_lista);
                                                              if ($result_lista > 0) {
                                                                    while ($data_lista=mysqli_fetch_array($query_lista)) {
                                                                      $foto = 'img/uploads/'.$data_lista['foto'];
                                                             ?>
                                                             <tr id="fila_producto<?php echo $data_lista['idproducto'];?>">
