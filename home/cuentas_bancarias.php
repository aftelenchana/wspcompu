                                                  ...
                                                  <div class="dt-responsive table-responsive">
                                                      <table id="tabla_productos" class="table table-striped table-bordered nowrap">
                                                          ...
                                                          <tbody>
                                                            ...
                                                            $query_lista = mysqli_query($conection,"SELECT * FROM cuentas_bancarias_factu WHERE cuentas_bancarias_factu.estatus = '1' AND cuentas_bancarias_factu.iduser = '$iduser'
                                                              ORDER BY cuentas_bancarias_factu.id DESC
                                                       ");
                                                             while ($data_lista=mysqli_fetch_array($query_lista)) {
                                                             ?>
                                                              <tr>
                                                                  <td><?php echo $data_lista['titular_cuenta'];?> </td>
                                                                  <td><?php echo $data_lista['nombre_cuenta'];?> </td>
                                                                  <td><?php echo $data_lista['tipo_cuenta'];?></td>
                                                                  <td><?php echo $data_lista['numero_cuenta'];?> </td>
                                                                  <td>Editar </td>
                                                              </tr>
                                                              <?php
                                                              }
