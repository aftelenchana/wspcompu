  ...
  mysqli_set_charset($conection, 'utf8'); //linea a colocar
      ...
      if (empty($_SESSION['active'])) {
       ...
       $iduser= $_SESSION['id'];
           ...
           $movimiento = $_GET['movimiento_venta'];
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <div class="card">
                                              ...
                                              <h3 style="text-align: center;">Detalles del Movimiento <?php echo $movimiento ?></h3>
                                              ...
                                              <table>
                                                <tr class="titu_table">
                                                    ...
                                                    <?php
                                                      ...
                                                      $query_lista = mysqli_query($conection,"SELECT producto_venta.foto,producto_venta.nombre as 'nombre_producto',
                                                        producto_venta.idproducto as 'idproducto',ventas.cantidad_producto,historial_bancario.cantidad_parcial,
                                                        historial_bancario.cantidad,historial_bancario.cantidad_comision,producto_venta.precio,historial_bancario.fecha, DATE_FORMAT(historial_bancario.fecha, '%W  %d de %b %Y %h:%m:%s') as 'fecha'  FROM `historial_bancario`
                                                      INNER JOIN ventas ON ventas.id = historial_bancario.id_venta
                                                      ...
                                                      WHERE historial_bancario.id = '$movimiento'");
                                                       ...
                                                       <tr>
                                                                 ...
                                                                 <td data-titulo="ID producto"><a href="producto?idp=<?php echo $data_lista['idproducto'];?>"><?php echo $data_lista['idproducto'];?></a> </td>
                                                                 <td data-titulo="Precio/Unidad">$<?php echo $data_lista['precio'];?></td>
                                                                  <td data-titulo="Cantidad Producto"><?php echo $data_lista['cantidad_producto'];  ?></td>
                                                                 <td data-titulo="Comision">$<?php echo $data_lista['cantidad_comision'];  ?></td>
                                                                 <td data-titulo="Monto Neto">$<?php echo $data_lista['cantidad_parcial']; ?></td>
                                                                 <td data-titulo="Suma Total">$<?php echo $data_lista['cantidad']; ?></td>
