...
<html lang="es">
    ...
    include "scripts/modal_cuenta.php";
    if (empty($longitud)) {
      //sacamos las direcciones seccionales
      function getRealIP(){
    ...
    if ($ambito_area == 'prueba') {
     ...
     $longitud_view = $datos['lon'];
     $latitude_view = $datos['lat'];
    }else {
      $longitud_view = $result['longitud'];
      $latitude_view = $result['latitud'];
    }
                                          ...
                                          <div class="cover-profile">
                                              <div class="profile-bg-img">
                                                  ...
                                                  <div class="card-block user-info">
                                                      <div class="col-md-12">
                                                          <div class="media-left boton_editar_foto_perfil resultado_imagen_upload_perfil">
                                                            <a href="#" class="profile-image " tabindex="-1" aria-disabled="true" style="pointer-events: none; opacity: 0.6;">
                                                          ...
                                                          <div class="media-body row">
                                                              ...
                                                              <div>
                                                                  <div class="pull-right cover-btn">
                                                                      ...
                                                                      <button type="button" class="btn btn-primary m-r-10 m-b-5" id="boton-copiar">
                                                                         <i class="icofont icofont-plus"></i>
                                                                         <span>Copiar mi Enlace</span>
                                                                         <input type="text" id="enlace-oculto" value="<?php echo $url_img_upload ?>" style="position: absolute; left: -9999px;">
                                                                     </button>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                                              ...
                                                                              <div class="col-lg-12 col-xl-6">
                                                                                  <div class="table-responsive">
                                                                                      <table class="table m-0">
                                                                                          <tbody>
                                                                                              <tr>
                                                                                                  <th scope="row" class="editar_nombres" nombresh= "<?php echo $nombres ?>">
                                                                                                    Nombres
                                                                                                  </th>
                                                                                              ...
                                                                                              <tr>
                                                                                                  ...
                                                                                                  <td class="result_identidicacion"><?php echo $numero_identidad ?></td>
                                                                                              </tr>
                                                                                              <tr>
                                                                                                  <th scope="row">
                                                                                                      Fecha Registro
                                                                                              ...
                                                                                              <tr>
                                                                                                  ...
                                                                                                  <td><?php
                                                                                                  if ($id_desarrolador == '' || $id_desarrolador == '0') {
                                                                                                    $id_desarrolador = mb_strtoupper(md5($password_user.$iduser));
                                                                                                    $query_insert=mysqli_query($conection,"UPDATE usuarios SET id_e='$id_desarrolador' WHERE id='$iduser' ");

                                                                                                  }

                                                                                                   echo $id_desarrolador ?></td>
                                                                                              </tr>
                                                                                              <tr>
                                                                                                  <th scope="row">
                                                                                                      Ciudad
                                                                                  ...
                                                                                  <div class="table-responsive">
                                                                                      <table class="table">
                                                                                          <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <th scope="row" class="editar_nombre_empresa" nombre_empresa= "<?php echo $nombre_empresa ?>">
                                                                                                    Nombre Comercial
                                                                                                </th>
                                                                                                <td class="result_nombre_empresa">
                                                                                            ...
                                                                                            <tr>
                                                                                                <th scope="row" class="editar_razon_social" razon_social= "<?php echo $razon_social ?>">
                                                                                                    Razón Social
                                                                                                </th>
                                                                                                <td class="result_razon_social">
