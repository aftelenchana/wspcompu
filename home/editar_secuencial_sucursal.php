                                              ...
                                              <div class="row estilos_parametros">
                                                <div class="col">
                                                  <form method="post" name="reset_secuencial" id="reset_secuencial" onsubmit="event.preventDefault(); sendData_reset_secuencial();">
                                                      ...
                                                      <div class="mb-3">
                                                          <label for="nuevoSecuencialInput" class="form-label">Agrega el nuevo Secuencial</label>
                                                      ...
                                                      <input type="hidden" name="action" value="agregar_secuencial">
                                                      <div class="modal-footer">
                                                        <input type="hidden" name="codigo_sucursal" value="<?php echo $sucursal_facturacion ?>">
                                                        <button type="submit" class="btn btn-primary">Edita tu Secuencial</button>
                                                      </div>
