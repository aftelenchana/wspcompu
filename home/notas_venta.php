...
<html lang="es">
    ...
    <head>
        <title>Notas Ventas Autorizadas</title>
                                                    ...
                                                    <table id="tabla_facturas" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          $query_lista = mysqli_query($conection,"SELECT * FROM `nota_venta_autorizada` WHERE nota_venta_autorizada.id_emisor  = '$iduser' ORDER BY `nota_venta_autorizada`.`fecha`  DESC");
                                                           ...
                                                           ?>
                                                            <tr>
                                                              <td class="" data-titulo="Codigo"><?php echo str_pad($data_lista['codigo_factura'], 9, "0", STR_PAD_LEFT);?></td>
                                                              ...
                                                              <td class="" data-titulo="Cédula Recpetor"><?php echo $data_lista['cedula_receptor']; ?>  </td>
                                                              <td class="" data-titulo="Celular Cliente"><?php echo $data_lista['email_receptor']; ?>  </td>
                                                              <td class="" data-titulo="Celular Cliente"><?php echo $data_lista['celular_receptor']; ?>  </td>
                                                              <td class="" data-titulo="Pdf"> <a download href="<?php echo $data_lista['url']; ?>/home/facturacion/facturacionphp/comprobantes/nota_venta_autorizada/<?php echo $data_lista['clave_acceso'];?>.pdf"><img src="img/reacciones/pdf.png" width="45px" alt=""></a>  </td>
                                                          </tr>
                                                            <?php
                                                            }
                                                            }
