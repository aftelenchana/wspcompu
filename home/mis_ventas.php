    ...
    <body>
     ...
     if ($_SESSION['rol'] == 'cuenta_usuario_venta') {
       ...
       require 'scripts_usuario_venta/iconos.php';
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="contenedor_fgt">
                                          <div class="histial_bancario_general" style="padding: 15px;">
                                            <div class="">
                                              <table>
                                                <tr class="titu_table">
                                                  ...
                                                  <td>Estado-Pago</td>
                                                  <td>Agregar Entrega</td>
                                                  <td>Solicitar Pago</td>
                                                  <td>Reportes</td>
                                                  <td>Detalles</td>
                                                </tr>
                                                <?php
                                              ...
                                              WHERE producto_venta.id_usuario = $iduser
                                              ");
                                            ...
                                            WHERE producto_venta.id_usuario = '$iduser'
                                            GROUP BY ventas.id
                                            ORDER BY `ventas`.`fecha` DESC LIMIT $desde,$por_pagina");
                                                 ...
                                                 ?>
                                                 <tr>
                                                   <td data-titulo="#ID"><?php echo $data_lista['id'];?></td>
                                                   <td data-titulo="Fecha"><?php echo $data_lista['fecha'];?></td>
                                                   <td data-titulo="Estado"><?php echo $data_lista['estado'];?></td>
                                                   <td data-titulo="Producto"><a href="producto?codigo=<?php echo ($data_lista['idp']);?>"> <img style="width: 80px;border-radius: 50px;" src="img/uploads/<?php echo $data_lista['foto']; ?>" alt=""> </a> </td>
                                                   ...
                                                   <td data-titulo="Estado-Entrega"><?php echo $data_lista['estado_fisico']; ?></td>
                                                   <td data-titulo="Estado-Pago">  <?php echo $data_lista['solicitud_pago']; ?></td>
                                                   <td data-titulo="Agregar Entrega"> <a venta="<?php echo $data_lista['id']; ?>" class="agregar_entrega_producto entregar_producto_at" href="#">Entregar</a> </td>
                                                   <td data-titulo="Solicitar Pago"><a class="solicitar_pago" venta="<?php echo $data_lista['id']; ?>"   href="#"> Pago</a> </td>
                                                   <td data-titulo="Reporte"> <a class="ver_reportes" venta="<?php echo $data_lista['id']; ?>"   href="#">Reportes </a> </td>
                                                   <td data-titulo="Detalles"> <a href="detalle-venta.php?venta=<?php echo $data_lista['id']; ?>">Detalles</a> </td>
                                                 </tr>
                                                 <?php
                                               }
                                             }
        ...
        <script src="jquery_ventas/ventas.js"></script>
        <script src="java/visitadores.js"></script>
