...
if ($_POST['action'] == 'verificar_guardar_email') {
   $host = $_POST['host'];
   $puerto = $_POST['puerto'];
   $email_user_name_envio = mb_strtoupper($_POST['email_user_name_envio']);
   ...
   try {
      ...
      //  $query_update =mysqli_query($conection,"UPDATE usuarios SET host_envio= 'mail.guibis.com'  WHERE id='$iduser' ");

        $query_update =mysqli_query($conection,"UPDATE usuarios SET host_envio= '$host',puerto_email_envio= '$puerto',
          email_user_name_envio= '$email_user_name_envio',password_envio_email= '$password',descripcion_envio_email= '$descripcion'  WHERE id='$iduser' ");
