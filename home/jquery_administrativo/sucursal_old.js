...
var tabla_sucursales = $('#tabla_sucursales').DataTable({
    "ajax": {
        "url": "jquery_administrativo/sucursal.php",
        "type": "POST",
        "data": {
    ...
    "columns": [
        ...
        { "data": "direccion_sucursal", "render": function(data, type, row) {
                return '<a href="editar_secuencial_sucursal?codigo_sucursal=' + row.id + '">' + data + '</a>';
            }},
