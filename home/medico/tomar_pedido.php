...
$id_transporte= $_SESSION['id'];
      ...
      if ($_POST['action'] == 'tomar_pedido') {
        ...
        $transporte_guibis    = $data_verificador_secuencial['transporte_guibis'];
          ...
          $query_edit_tomar_pedido=mysqli_query($conection,"UPDATE comprobantes SET transporte_guibis= '$id_transporte',latitude_actual = '-2.059148978871448',longitude_actual= '-79.88914003535304' ,estado_f= 'INICIANDO TRANSPORTE'  WHERE codigo_mesa='$codigo_peidido_viaje' ");
