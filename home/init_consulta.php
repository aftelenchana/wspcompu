...
<html lang="es">
    ...
    AND consultas_medicas.estado = 'INICIADO' ");
    ...
    if ($result_consulta > 0) {
      ...
      $codigo_unico = $data_consulta['codigo_unico'];
    ...
    $responsable_documento = informacion_recursos_humanos_accionado($iddocumento, $roldocumento, $conection);
      ...
      $codigo_unico = mb_strtoupper(md5(date('d-m-Y H:m:s').$iduser.$paciente));
      ...
      $level = 'H';
      $frameSize = 5;
      $contenido = ''.$url.'/home/init_consulta?codigo='.$paciente.'&codigo_unico='.$codigo_unico.'';
      QRcode::png ($contenido,$filename,$level,$tamanio,$frameSize);


      $query_insert=mysqli_query($conection,"INSERT INTO consultas_medicas(iduser,paciente,url_qr,qr_img,codigo_unico,estado)
                                             VALUES('$iduser','$paciente','$url','$qr_img','$codigo_unico','INICIADO') ");

                if ($query_insert) {
                  $estado = 'CONSULTA INICIADA ESTE MOMENTO';               // code...
                }else {
                  $estado = 'CONSULTA NO INICIADA ERROR EN EL SERVIDOR';
                }

                $query_verificador_consulta = mysqli_query($conection,"SELECT *
             FROM `consultas_medicas`
             WHERE consultas_medicas.iduser = '$iduser' AND consultas_medicas.estatus = '1' AND consultas_medicas.codigo_unico = '$codigo_unico' ");
     ...
     <div class="pcoded-content">
                                 ...
                                 <div class="tab-content">
                                   ...
                                   <div class="tab-pane" id="compartir_consulta" role="tabpanel">
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col">
                                                   ...
                                                   <div class="mb-3">
                                                     ...
                                                     <button type="button"  class="btn btn-info" id="btn_dictado_problema_actual">Iniciar dictado <i class="fas fa-microphone"></i></button>
                                                   </div>
                                                 </div>
                                                 <div class="col">
                                       ...
                                       <div class="card">
                                          ...
                                          <div class="col-md-6 mb-3">
                                              ...
                                              <div class="mb-3">
                                                 ...
                                                 <div class="contenedor_boton_enviar">
                                                   <button type="submit" <?php echo $estado_habilitacion ?> class="btn btn-primary">Procesar Documento <i class="fas fa-plus"></i></button>
                                     ...
                                     <div class="tab-pane" id="contacts" role="tabpanel">
                                      ...
                                      <style media="screen">
                                      .total_scroll_recetas {
          overflow-x: auto; /* Agrega scroll horizontal */
          white-space: nowrap; /* Evita que los elementos dentro del div se dividan en varias líneas */
          }

          .total_scroll_recetas::-webkit-scrollbar {
          height: 8px; /* Altura del scroll bar */
          }

          .total_scroll_recetas::-webkit-scrollbar-thumb {
          background-color: #888; /* Color de la barra de desplazamiento */
          border-radius: 10px; /* Bordes redondeados */
          }

          .total_scroll_recetas::-webkit-scrollbar-thumb:hover {
          background-color: #555; /* Color cuando se pasa el cursor */
          }
                                      </style>


                                       <div class="card total_scroll_recetas">
                                           <div class="card-block">
                                             <style media="screen">
                                             .autocomplete-list {
                                                 position: absolute;
                                                      ...
                                                      <div class="col-md-6">
                                                          ...
                                                          for ($i = 0; $i < 4; $i++) {
                                                              ...
                                                              while ($proveedor = mysqli_fetch_array($query_proveedor)) {
                                                                  echo '<option value="' . $proveedor['codigo'] . '- ' . $proveedor['nombre'] . '">' . $proveedor['codigo'] . '- ' . $proveedor['nombre'] . '</option>';
                                                              }
                                                              echo '</select>
                               ...
                               for ($i = 0; $i < 5; $i++) {
                                   echo '<tr id="fila_' . ($i + 1) . '">
                                           ...
                                           <td><input type="text" class="form-control input-guibis-sm" id="cantidad_' . ($i + 1) . '" value="" name="cantidad[]"></td>
                                           <td>
                                           <select class="form-control input-guibis-sm" id="dosis_' . ($i + 1) . '" name="dosis[]">
        ...
        <script src="medico/init_consulta.js?v=3"></script>
