function sendData_solciitar_ifnro_compras(){
  $('.notificacion_guardar_compra').html(' <div class="notificacion_negativa">'+
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      if (info.noticia =='no_factura') {
        $('.notificacion_guardar_compra').html('<div class="alert alert-danger" role="alert">Error '+info.mensaje+'!</div>')
