...
include "../../coneccion.php";
  ...
  'NOMBRE_COMERCIAL' =>$datos['NOMBRE_COMERCIAL'],'ESTADO_CONTRIBUYENTE' =>$datos['ESTADO_CONTRIBUYENTE'],'DESCRIPCION_PARROQUIA' =>$datos['DESCRIPCION_PARROQUIA'],'CELULAR' =>$datos['CELULAR']
,'EMAIL' =>$datos['EMAIL'],'DIRECCION' =>$datos['DIRECCION']);
      echo json_encode($arrayName,JSON_UNESCAPED_UNICODE);
