...
tablaUsuarios = $('#tablaUsuarios').DataTable({
    "ajax":{
        "url": "jquery_empresa/consulta_veterinaria.php",
        "method": 'POST', //usamos el metodo POST
        "data":{opcion:opcion,consulta:consulta}, //enviamos opcion 4 para que haga un SELECT
        "dataSrc":""
    ...
    var id = 1;
        $.ajax({
          ...
          success: function(data) {
            ...
            $.ajax({
             url: "jquery_empresa/consulta_veterinaria2.php",
              type:'POST',
              async: true,
              data: {action:action,cliente:cliente,consulta:consulta},
...
$('#formproductos2').submit(function(e){
    ...
    var id = 1;
        $.ajax({
          ...
          type: "POST",
          datatype:"json",
          data:  {id:id, nombre_producto:nombre_producto, descripcion_producto:descripcion_producto, valor_unidad:valor_unidad,opcion:opcion,cantidad_producto:cantidad_producto,tipo_ambiente:tipo_ambiente,codigos_impuestos:codigos_impuestos,detalle_extra:detalle_extra,idproducto:idproducto,cantidad_descuento:cantidad_descuento,consulta:consulta},
          success: function(data){
            tablaUsuarios.ajax.reload(null, false);
