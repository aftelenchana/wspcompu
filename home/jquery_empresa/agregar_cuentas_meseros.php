...
include "../../coneccion.php";
 ...
 require '../QR/phpqrcode/qrlib.php';
    ...
    if ($_POST['action'] == 'agregar_cuentas_meseros') {
      ...
      $query_insert=mysqli_query($conection,"INSERT INTO restaurant_meseros(nombres_apellidos,tipo_identificacion,identificacion,direccion,celular,email,foto,iduser,qr_imagen,qr_contenido,password)
                                    VALUES('$nombres_apellidos','$tipo_identificacion','$identificacion','$direccion','$celular','$email','$imgProducto','$iduser','$qr_img','$contenido','$password') ");
