                                                  ...
                                                  <div class="dt-responsive table-responsive">
                                                      <table id="tabla_productos" class="table table-striped table-bordered nowrap">
                                                          ...
                                                          <tbody>
                                                            ...
                                                            $query_lista = mysqli_query($conection,"SELECT notas.id,notas.nota, DATE_FORMAT(notas.fecha, '%W  %d de %b %Y %h:%m:%s') as 'fecha' FROM `notas`
                                                      WHERE notas.iduser  = '$iduser' AND notas.iduser='$iduser' AND notas.estatus='1'
                                                        ORDER BY `notas`.`fecha` DESC");
                                                             ...
                                                             <tr class="fila<?php echo $data_lista['id'];?>" id="fila<?php echo $data_lista['id'];?>" >
                                                               ...
                                                               <td class="" data-titulo="Receptor"><?php echo $data_lista['nota']; ?>  </td>
                                                               <td class="" data-titulo="Acciones"> <button type="button" nota= "<?php echo $data_lista['id'];?>" class="btn btn-danger realizar_tarea" name="button">Realizar Tarea</button> </td>
