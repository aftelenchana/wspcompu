...
<html lang="es">
    ...
    <head>
        <title>Recorrido Transporte</title>
    ...
    require 'scripts/cabezera_general.php';
                                      ...
                                      <div class="col-sm-12">
                                          <div class="card">
                                              <div class="card-header table-card-header">
                                                  <h5>Recorrido Transporte</h5>
                                              </div>

                                              <input type="hidden" class="codigo_movimiento" name="codigo_movimiento" id="codigo_movimiento" value="15">

                                               <button type="button" class="btn btn-success boton_tomar_pedido" secuencial='<?php echo $data_lista['codigo_mesa'] ?>' id="boton_tomar_pedido" name="button">Tomar Pedido </button>
                                               <div class="row">
                                                 <div class="col-12">
        ...
        <div class="modal fade" id="tomar_pedido" tabindex="-1" aria-labelledby="errorModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="card-header bg-success text-white">
            <h5 class="modal-title" id="proveedorModalLabel">Tomar Viaje  <?php echo $code ?></h5>
          </div>
              <div class="modal-body text-center">
               <form action=""  name="tomar_pedido_transporte" id="tomar_pedido_transporte" onsubmit="event.preventDefault(); sendData_tomar_pedido_transporte();" >
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-primary acciona_btn_tomar_viaje">Tomar Viaje</button>
                <input type="hidden" name="distancia" id="distancia" value="">
                <input type="hidden" name="tiempo" id="tiempo"  value="">
                <input type="hidden" name="action" id="action_modal_entrega"  value="tomar_pedido" required>
                <input type="hidden" name="codigo_peidido_viaje" value="<?php echo $code ?>">
                <button type="button" class="btn btn-danger mobtn" data-dismiss="modal">Cerrar <i class="fas fa-times-circle"></i></button>
              </div>
              <div class="notificacion_tomar_pedido_transporte" style="text-align: center;"></div>
            </form>
            </div>
          </div>
        </div>
