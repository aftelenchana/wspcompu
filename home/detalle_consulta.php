                                             ...
                                             <form method="post" name="receta" id="receta" onsubmit="event.preventDefault(); sendData_receta();" style="padding: 10px;">
                                               <div class=" mt-5">
                                                 ...
                                                 <div class="contenedor_boton_enviar">
                                                   ...
                                                   <?php if ($estado == 'FINALIZADO'): ?>
                                                     <a class="btn btn-danger"  href="medico/recetas/receta_<?php echo $codigo_unico ?>.pdf" download>Descargar Receta <i class="fas fa-file-pdf"></i> </a>
                                                   <?php endif; ?>
                                           ...
                                           <div class="card-block">
                                             <form method="post" name="antecedentes_alex" id="antecedentes_alex" onsubmit="event.preventDefault(); sendData_antecedentes_ales();" style="padding: 10px;">
                                              ...
                                              <div class="row">
                                                 ...
                                                 <?php if (!empty($responsable_documento)): ?>
                                                   <a class="btn btn-danger"  href="medico/certificados/certificado_<?php echo $codigo_unico ?>.pdf" download>Descargar Receta <i class="fas fa-file-pdf"></i> </a>
                                                 <?php endif; ?>
