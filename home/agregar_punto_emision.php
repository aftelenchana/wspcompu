  ...
  mysqli_set_charset($conection, 'utf8'); //linea a colocar
      ...
      if (empty($_SESSION['active'])) {
       ...
       $query_consulta = mysqli_query($conection, "SELECT * FROM sucursales
          WHERE sucursales.iduser ='$iduser'  AND sucursales.estatus = '1' AND sucursales.id = '$codigo_sucursal' ");

          $data_sucursal = mysqli_fetch_array($query_consulta);
...
<html lang="es">
    <head>
        <title>Puntos de Emisión para Esatablecimiento <?php echo $data_sucursal['establecimiento'] ?>  </title>
    ...
    <body>
     ...
     if ($_SESSION['rol'] == 'cuenta_usuario_venta') {
       ...
       require 'scripts_usuario_venta/iconos.php';
              ...
              <input type="hidden" name="codigo_sucursal" id="codigo_sucursal" value="<?php echo $codigo_sucursal ?>">
                                      ...
                                      <div class="col-sm-12">
                                          <div class="card">
                                              <div class="card-header table-card-header">
                                                  <h5>Puntos de Emisión para Establecimiento <?php echo $data_sucursal['establecimiento'] ?>  </h5> <button type="button" class="btn btn-primary" id="boton_agregar_sucursal" name="button">Agregar Puntos de Emisión <i class="fas fa-plus"></i></button>
                                              </div>
                                                      ...
                                                      <table id="tabla_sucursales" class="table table-striped table-bordered nowrap">
                                                          <thead>
                                                              <tr>
                                                                ...
                                                                <th>Secuencual en Facturación</th>
           ...
           max-width: 100px; /* Ajusta el ancho máximo según tus necesidades */
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="proveedorModalLabel">Agregar Punto de Emisión para la Sucursal </h5>
                        ...
                        <form action=""  id="add_sucursal" >
                          <div class="row">
                            ...
                            <div class="modal-footer">
                              ...
                              <input type="hidden" name="establecimiento" value="<?php echo $codigo_sucursal ?>">
                              <input type="hidden" name="direccion_sucursal" value="<?php echo $data_sucursal['direccion_sucursal'] ?>">
                              <button type="button" class="btn btn-danger mobtn" data-dismiss="modal">Cerrar <i class="fas fa-times-circle"></i></button>
                              <button type="submit" class="btn btn-primary">Agregar Punto de Emisión <i class="fas fa-plus"></i></button>
                            </div>
                ...
                <div class="modal fade" id="modal_editar_sucursal" tabindex="-1" aria-labelledby="proveedorModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="proveedorModalLabel">Editar Punto de Emisión con Código Interno #<span id="codigo_sucursal_in" ></span> </h5>
                        <button type="button" class="btn-danger" data-dismiss="modal"><i class="fas fa-times-circle"></i>  </button>
                      </div>
                      <div class="modal-body">
                        ...
                        <form action=""  id="update_sucursal" >
                          <div class="row">
                            <div class="col">
                              <div class="mb-3">
                                  <label for="" class="form-label">Punto de Emisión</label>
                                  <input type="number" required class="form-control" name="punto_emision" required id="punto_emision_update" placeholder="Punto de Emisión">
                              </div>
                            </div>
                            ...
                            <div class="modal-footer">
                              <input type="hidden" required class="form-control" name="direccion_sucursal" required id="direccion_sucursal_update" placeholder="Agregar Direccion Sucursal">
                              <input type="hidden" required class="form-control" name="establecimiento" required id="establecimiento_update" placeholder="Establecimiento">
                              <input type="hidden" name="action" value="editar_sucursal">
                              <input type="hidden" name="id_sucursal" id="id_sucursal" value="">
                              <button type="button" class="btn btn-danger mobtn" data-dismiss="modal">Cerrar <i class="fas fa-times-circle"></i></button>
                              <button type="submit" class="btn btn-primary">Editar Punto de Emisión</button>
                            </div>
        ...
        <script src="files/bower_components/datatables.net-buttons/js/buttons.print.min.js"></script>
        <script src="files/bower_components/datatables.net-buttons/js/buttons.html5.min.js"></script>
        <script type="text/javascript" src="jquery_administrativo/punto_emision_sucursal.js"></script>
