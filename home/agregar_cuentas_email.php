...
include "../coneccion.php";
  ...
  mysqli_set_charset($conection, 'utf8'); //linea a colocar
      ...
      if (empty($_SESSION['active'])) {
       ...
       $cliente = $_GET['cod'];
       $query_cliente = mysqli_query($conection, "SELECT * FROM clientes WHERE clientes.id = $cliente");
...
<html lang="es">
    ...
    <head>
        <title>Agregar Correos del cliente <?php echo $nombres_cliente ?></title>
                                      ...
                                      <div class="col-sm-12">
                                          <div class="card">
                                              <div class="card-header table-card-header">
                                                  <h5>Cuentas de Email del Cliente <?php echo $nombres_cliente ?> </h5> <button type="button" class="btn btn-primary" id="boton_agregar_email_cliente" name="button"> <i class="fas fa-plus"></i>Agregar Cuenta de Email</button>
                                              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="proveedorModalLabel">Agregar Email Envio al cliente <?php echo $nombres_cliente ?></h5>
