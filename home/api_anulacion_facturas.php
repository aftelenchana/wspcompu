...
<html lang="es">
    ...
    <head>
        <title>Apí Anulación Facturas</title>
        <meta charset="utf-8" />
                                      ...
                                      <div class="col-sm-12">
                                          <div class="card">
                                              <div class="card-header table-card-header">
                                                  <h5>Api de Anulación de Facturas de Guibis.com</h5>
                                              </div>
                                              <?php
                                               ...
                                               <div class="contenedor_parrafos_principales">
                                                 <p>Hola <?php echo $nombres ?> nos encanta saber que eres parte de nuestra Familia de Desarrollo y para esto te presentamos la api de Anulación de  Facturas  de <a target="_blank" href="https://guibis.com">guibis.com</a>,
                                               ...
                                               <div class="card">
                                                   ...
                                                   <div class="card-block">
                                                       <p>Te presento el JSON que debes de formar para poder utilizar tu API REST el cual se conecta a  <strong><?php echo $url2 ?>/home/facturacion/facturacionphp/controladores/api_nota_credito</strong> .</p>
                                                       <h6 class="m-t-20 f-w-600">Usage:</h6>
                                                       <pre>
                                                   <code class="language-markup">
                                                     {
                                                    "key":"<?php echo $id_desarrolador ?>",
                                                    "user_in":"<?php echo $user_in ?>",
                                                    "razon_modficiacion":"Error al emitir la factura",
                                                    "clave_acceso_factura":"0812202301092301328800120010030000000351234567812",
                                                    "sucursal_emision":"8"
                                                    }
                                                   </code>
                                               </pre>
                                               ...
                                               <div class="contenedor_parrafos_principales">
                                                 <p>Para ello deberas de tener un registro de las facturas y enviar la clave de la factura que deseas que se anule ya sea por diferentes motivos</p>
                                               </div>
                                                    </div>
                                               </div>
                                          </div>
